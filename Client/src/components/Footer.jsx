    ...
    <footer className="text-center bg-main-dark-bg text-white">
      ...
      {/* <div className="container px-6 pt-6">
        <div className="flex justify-center mb-6">
          ...
          <a
            href="mailto:mohdnaeemghadai@gmail.com"
            type="button"
            className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
          ...
          <a
            href="https://github.com/NAEEMGHADAI"
            type="button"
            className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
      ...
      <div className="text-center p-4" style={{ backgroundColor: "#1a202c" }}>
        © 2023 Copyright: &nbsp;
        <a className="text-whitehite" href="https://naeemghadai.github.io/">
          Ghadai Mohd Naeem
        </a>
      </div>
    </footer>
